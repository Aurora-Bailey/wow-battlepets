...
class Sell {
  ...
  async request (query) {
    ...
    return pets.map(p => {return {psid: p.stats.speciesId, level: p.stats.level, quality: p.stats.petQualityId, guid: p.battlePetGuid, selected: true, match: false, sellIndex: p.sellIndex, sellAt: p.sellAt}})
  }
