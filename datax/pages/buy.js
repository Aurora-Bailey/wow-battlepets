...
class Buy {
  ...
  async request (query) {
    ...
    {projection: {_id: 0, auc: 1, buyout: 1, median: 1, percent: 1, profit: 1, soldNum: 1, petQualityId: 1, petLevel: 1, petBreedId: 1, petSpeciesId: 1}}).toArray()
    live.map(item => item.buy = false)
    return live
  }
}
